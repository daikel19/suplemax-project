...
// src/gen/client/operations/updateMessage.ts
...
// src/gen/client/operations/selectMessage.ts
...
var Client = class {
  ...
  createFile = async (input) => {
    const { path, headers, query, body } = parseReq22(input);
    const mapper = this.props.toAxiosRequest ?? toAxiosRequest;
    const axiosReq = mapper({
      method: "post",
      path,
...
// src/eventsource.ts
var import_event_source_polyfill = __toESM(require("event-source-polyfill"));
var makeEventSource = (url, props) => {
  const source = new import_event_source_polyfill.default.EventSourcePolyfill(url, {
...
var messageCreated_z_default = import_zod.z.object({
  ...
  data: import_zod.z.object({
    id: import_zod.z.string().describe("Id of the [Message](#schema_message)"),
    ...
    payload: import_zod.z.union([
      ...
      import_zod.z.object({
        ...
        disableFreeText: import_zod.z.boolean().optional(),
        ...
        items: import_zod.z.array(
          import_zod.z.union([
            ...
            import_zod.z.object({
              ...
              payload: import_zod.z.object({ markdown: import_zod.z.string().min(1) })
            }),
            import_zod.z.object({
              type: import_zod.z.literal("image"),
              payload: import_zod.z.object({ imageUrl: import_zod.z.string().min(1) })
            }),
            import_zod.z.object({
              type: import_zod.z.literal("audio"),
              payload: import_zod.z.object({ audioUrl: import_zod.z.string().min(1) })
            }),
            import_zod.z.object({
              type: import_zod.z.literal("video"),
              payload: import_zod.z.object({ videoUrl: import_zod.z.string().min(1) })
            }),
            import_zod.z.object({
              type: import_zod.z.literal("file"),
              payload: import_zod.z.object({
      ...
      import_zod.z.object({
        ...
        data: import_zod.z.union([import_zod.z.any(), import_zod.z.null()]).optional(),
        type: import_zod.z.literal("custom")
      }),
      import_zod.z.object({ reaction: import_zod.z.string(), type: import_zod.z.literal("reaction") })
    ...
    replyTo: import_zod.z.string().describe("ID of the message this message is replying to").optional(),
    selectedBy: import_zod.z.string().describe(
...
// src/gen/signals/messageUpdated.z.ts
var import_zod2 = require("zod");
var messageUpdated_z_default = import_zod2.z.object({
  type: import_zod2.z.literal("message_updated"),
  data: import_zod2.z.object({
    id: import_zod2.z.string().describe("Id of the [Message](#schema_message)"),
    createdAt: import_zod2.z.string().datetime().describe(
      "Creation date of the [Message](#schema_message) in ISO 8601 format"
    ),
    payload: import_zod2.z.union([
      import_zod2.z.object({ audioUrl: import_zod2.z.string().min(1), type: import_zod2.z.literal("audio") }),
      import_zod2.z.object({
        title: import_zod2.z.string().min(1),
        subtitle: import_zod2.z.string().min(1).optional(),
        imageUrl: import_zod2.z.string().min(1).optional(),
        actions: import_zod2.z.array(
          import_zod2.z.object({
            action: import_zod2.z.enum(["postback", "url", "say"]),
            label: import_zod2.z.string().min(1),
            value: import_zod2.z.string().min(1)
          })
        ),
        type: import_zod2.z.literal("card")
      }),
      import_zod2.z.object({
        ...
        type: import_zod2.z.literal("carousel")
      }),
      import_zod2.z.object({
        text: import_zod2.z.string().min(1),
        options: import_zod2.z.array(
          import_zod2.z.object({ label: import_zod2.z.string().min(1), value: import_zod2.z.string().min(1) })
        ),
        disableFreeText: import_zod2.z.boolean().optional(),
        type: import_zod2.z.literal("choice")
      }),
      import_zod2.z.object({
        text: import_zod2.z.string().min(1),
        options: import_zod2.z.array(
        ...
        disableFreeText: import_zod2.z.boolean().optional(),
        type: import_zod2.z.literal("dropdown")
      }),
      import_zod2.z.object({
        fileUrl: import_zod2.z.string().min(1),
        title: import_zod2.z.string().min(1).optional(),
        type: import_zod2.z.literal("file")
      }),
      import_zod2.z.object({ imageUrl: import_zod2.z.string().min(1), type: import_zod2.z.literal("image") }),
      import_zod2.z.object({
      ...
      import_zod2.z.object({ videoUrl: import_zod2.z.string().min(1), type: import_zod2.z.literal("video") }),
      import_zod2.z.object({
        items: import_zod2.z.array(
          import_zod2.z.union([
            import_zod2.z.object({
            ...
            import_zod2.z.object({
              type: import_zod2.z.literal("markdown"),
              payload: import_zod2.z.object({ markdown: import_zod2.z.string().min(1) })
            }),
            import_zod2.z.object({
              type: import_zod2.z.literal("image"),
              payload: import_zod2.z.object({ imageUrl: import_zod2.z.string().min(1) })
            }),
            import_zod2.z.object({
              type: import_zod2.z.literal("audio"),
              payload: import_zod2.z.object({ audioUrl: import_zod2.z.string().min(1) })
            }),
            import_zod2.z.object({
              type: import_zod2.z.literal("video"),
              payload: import_zod2.z.object({ videoUrl: import_zod2.z.string().min(1) })
            }),
            import_zod2.z.object({
              type: import_zod2.z.literal("file"),
              payload: import_zod2.z.object({
        ...
        type: import_zod2.z.literal("bloc")
      }),
      import_zod2.z.object({
        markdown: import_zod2.z.string().min(1),
        type: import_zod2.z.literal("markdown")
      }),
      import_zod2.z.object({
        url: import_zod2.z.string(),
        name: import_zod2.z.string(),
        data: import_zod2.z.union([import_zod2.z.any(), import_zod2.z.null()]).optional(),
        type: import_zod2.z.literal("custom")
      }),
      import_zod2.z.object({ reaction: import_zod2.z.string(), type: import_zod2.z.literal("reaction") })
    ]).describe("Payload is the content of the message."),
    ...
    metadata: import_zod2.z.record(import_zod2.z.union([import_zod2.z.any(), import_zod2.z.null()])).describe("Metadata of the message").optional(),
    replyTo: import_zod2.z.string().describe("ID of the message this message is replying to").optional(),
    selectedBy: import_zod2.z.string().describe(
      "ID of the user who selected this message. Undefined if not selected."
    ).optional()
  }).describe(
    "The Message object represents a message in a [Conversation](#schema_conversation) for a specific [User](#schema_user)."
...
var webchatVisibility_z_default = import_zod3.z.object({
  type: import_zod3.z.literal("webchat_visibility"),
  data: import_zod3.z.object({
    visibility: import_zod3.z.union([
      import_zod3.z.literal("show"),
      import_zod3.z.literal("hide"),
      import_zod3.z.literal("toggle")
    ])
  })
});
...
var webchatConfig_z_default = import_zod4.z.object({
  type: import_zod4.z.literal("webchat_config"),
  data: import_zod4.z.object({ config: import_zod4.z.record(import_zod4.z.union([import_zod4.z.any(), import_zod4.z.null()])) })
});

// src/gen/signals/custom.z.ts
var import_zod5 = require("zod");
var custom_z_default = import_zod5.z.object({
  type: import_zod5.z.literal("custom"),
  data: import_zod5.z.object({ event: import_zod5.z.record(import_zod5.z.union([import_zod5.z.any(), import_zod5.z.null()])) })
});

// src/gen/signals/typingStarted.z.ts
var import_zod6 = require("zod");
var typingStarted_z_default = import_zod6.z.object({
  type: import_zod6.z.literal("typing_started"),
  data: import_zod6.z.object({ timeout: import_zod6.z.number().optional() })
});

// src/gen/signals/typingStopped.z.ts
var import_zod7 = require("zod");
var typingStopped_z_default = import_zod7.z.object({ type: import_zod7.z.literal("typing_stopped"), data: import_zod7.z.record(import_zod7.z.never()) });

// src/gen/signals/index.ts
var zod = {
  messageCreated: messageCreated_z_default,
  messageUpdated: messageUpdated_z_default,
...
var Client2 = class {
  ...
  selectMessage = (x) => this._auto.selectMessage(x);
