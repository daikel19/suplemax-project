...
var messageCreated_z_default = z.object({
  ...
  data: z.object({
    ...
    payload: z.union([
      ...
      z.object({ reaction: z.string(), type: z.literal("reaction") })
    ...
    replyTo: z.string().describe("ID of the message this message is replying to").optional(),
    selectedBy: z.string().describe(
...
var messageUpdated_z_default = z2.object({
  type: z2.literal("message_updated"),
  data: z2.object({
    id: z2.string().describe("Id of the [Message](#schema_message)"),
    createdAt: z2.string().datetime().describe(
      "Creation date of the [Message](#schema_message) in ISO 8601 format"
    ),
    payload: z2.union([
      z2.object({ audioUrl: z2.string().min(1), type: z2.literal("audio") }),
      z2.object({
        title: z2.string().min(1),
        subtitle: z2.string().min(1).optional(),
        imageUrl: z2.string().min(1).optional(),
        actions: z2.array(
          z2.object({
            action: z2.enum(["postback", "url", "say"]),
      ...
      z2.object({
        ...
        type: z2.literal("carousel")
      }),
      z2.object({
        text: z2.string().min(1),
        options: z2.array(
          z2.object({ label: z2.string().min(1), value: z2.string().min(1) })
        ),
        disableFreeText: z2.boolean().optional(),
      ...
      z2.object({ imageUrl: z2.string().min(1), type: z2.literal("image") }),
      z2.object({
        latitude: z2.number(),
        longitude: z2.number(),
      ...
      z2.object({ videoUrl: z2.string().min(1), type: z2.literal("video") }),
      z2.object({
        items: z2.array(
          z2.union([
            z2.object({
            ...
            z2.object({
              ...
              payload: z2.object({ markdown: z2.string().min(1) })
            }),
            z2.object({
              type: z2.literal("image"),
              payload: z2.object({ imageUrl: z2.string().min(1) })
            }),
            z2.object({
              type: z2.literal("audio"),
              payload: z2.object({ audioUrl: z2.string().min(1) })
            }),
            z2.object({
              type: z2.literal("video"),
              payload: z2.object({ videoUrl: z2.string().min(1) })
            }),
            z2.object({
              type: z2.literal("file"),
              payload: z2.object({
        ...
        type: z2.literal("bloc")
      }),
      z2.object({
        markdown: z2.string().min(1),
        type: z2.literal("markdown")
      }),
      z2.object({
        url: z2.string(),
        name: z2.string(),
        data: z2.union([z2.any(), z2.null()]).optional(),
        type: z2.literal("custom")
      }),
      z2.object({ reaction: z2.string(), type: z2.literal("reaction") })
    ]).describe("Payload is the content of the message."),
    userId: z2.string().describe("ID of the [User](#schema_user)"),
    conversationId: z2.string().describe("ID of the [Conversation](#schema_conversation)"),
    metadata: z2.record(z2.union([z2.any(), z2.null()])).describe("Metadata of the message").optional(),
    replyTo: z2.string().describe("ID of the message this message is replying to").optional(),
    selectedBy: z2.string().describe(
      "ID of the user who selected this message. Undefined if not selected."
    ).optional()
  }).describe(
    "The Message object represents a message in a [Conversation](#schema_conversation) for a specific [User](#schema_user)."
...
var webchatVisibility_z_default = z3.object({
  type: z3.literal("webchat_visibility"),
  data: z3.object({
    visibility: z3.union([
      z3.literal("show"),
      z3.literal("hide"),
...
var webchatConfig_z_default = z4.object({
  type: z4.literal("webchat_config"),
  data: z4.object({ config: z4.record(z4.union([z4.any(), z4.null()])) })
});

// src/gen/signals/custom.z.ts
import { z as z5 } from "zod";
var custom_z_default = z5.object({
  type: z5.literal("custom"),
  data: z5.object({ event: z5.record(z5.union([z5.any(), z5.null()])) })
});

// src/gen/signals/typingStarted.z.ts
import { z as z6 } from "zod";
var typingStarted_z_default = z6.object({
  type: z6.literal("typing_started"),
  data: z6.object({ timeout: z6.number().optional() })
});

// src/gen/signals/typingStopped.z.ts
import { z as z7 } from "zod";
var typingStopped_z_default = z7.object({ type: z7.literal("typing_stopped"), data: z7.record(z7.never()) });
